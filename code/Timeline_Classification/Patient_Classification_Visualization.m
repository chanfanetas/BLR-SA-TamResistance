...
Data=csvread('ClinicalData_dates.csv',1,1);
...
Table=readtable('ClinicalData_TreatmentType.csv');
...
Table_trst=readtable('ClinicalData_TreatmentStatus.csv');
...
Table_gs=readtable('ClinicalData_GenderAndStatus.csv');
...
Table_ncs=readtable('ClinicalData_NeoplasmCancerStatus.csv');
...
Table_enddate=readtable('ClinicalData_LastFollowup.csv');
...
Table_newTumor=readtable('ClinicalData_NewTumor.csv');
NewTumor=table2array(Table_newTumor(:,2:3));


%%%%% Radiation therapy start/end dates
Table_Rtx=readtable('ClinicalData_RadiationInfo.csv');
