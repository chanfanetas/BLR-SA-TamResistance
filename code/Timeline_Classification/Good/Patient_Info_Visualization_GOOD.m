...
Data=csvread('GoodClinicalData_dates.csv',1,1);
...
Table=readtable('GoodClinicalData_TreatmentType.csv');
...
Table_trst=readtable('GoodClinicalData_TreatmentStatus.csv');
...
Table_gs=readtable('GoodClinicalData_GenderAndStatus.csv');
...
Table_ncs=readtable('GoodClinicalData_NeoplasmCancerStatus.csv');
...
Table_enddate=readtable('GoodClinicalData_LastFollowup.csv');
...
Table_newTumor=readtable('GoodClinicalData_NewTumor.csv');
NewTumor=table2array(Table_newTumor(:,2:3));


%%%%% Radiation therapy start/end dates
Table_Rtx=readtable('GoodClinicalData_RadiationInfo.csv');
Rtx=table2array(Table_Rtx(:,[2 3 5 6 8 9]));
Rtx_ind=table2array(Table_Rtx(:,[4 7]));
